---
id: CNT-GDE-003
title: "Renting a Property in Cyprus: Complete Guide"
content_type: guide
status: draft
target_icp:
  - eu-national
...
target_keyword: "renting a property in cyprus"
secondary_keywords:
  - "renting in cyprus as a foreigner"
  - "cyprus rental agreement requirements"
  - "how to rent in cyprus"
  - "cyprus property rental guide"
word_count_target: 2500
related_process: PROC-PROP-001
source_knowledge:
  - PROC-PROP-001
assigned_to:
due_date:
...
<!-- META -->
<!-- Meta title (50-60 chars): Renting a Property in Cyprus: Complete Guide 2026 -->
<!-- Meta description (145-160 chars): Everything you need to know about renting in Cyprus. Rental contracts, deposits, the Tax Office stamping requirement, tenant rights, and typical costs in 2026. -->

# Renting a Property in Cyprus: Complete Guide
...
- **Company formation:** Used as proof of address for directors and shareholders

Get your rental agreement right from the start, or it will delay everything that comes after.
...
### Typical rental costs (April 2026)

Prices vary significantly by district, size, and condition. These are approximate monthly ranges:

| Property Type | Paphos | Limassol | Nicosia | Larnaca |
|---|---|---|---|---|
| 1-bedroom apartment | €500–€900 | €700–€1,200 | €550–€900 | €500–€800 |
| 2-bedroom apartment | €700–€1,300 | €900–€1,800 | €750–€1,200 | €650–€1,000 |
| 3-bedroom house/villa | €1,000–€2,500+ | €1,200–€3,000+ | €900–€2,000 | €800–€1,800 |

*Paphos is generally the most affordable district for quality-of-life value. Limassol is the most expensive, driven by the financial services sector.*
...
A legal Cyprus rental agreement should specify:

- Full names and passport/ID numbers of landlord and tenant
- Property address and description
- Rental start date and term (minimum 12 months for Yellow Slip eligibility)
- Monthly rent amount and due date
- Deposit amount and conditions for return
- Who is responsible for utilities
- Permitted use of the property (residential only)
- Notice period for termination
- Maintenance responsibilities

Agreements are typically in both Greek and English. Ensure you receive a copy in a language you understand before signing. If the agreement is only in Greek, ask for a translated version.
...
As of 1 January 2026, stamp duty on rental agreements in Cyprus has been abolished. You no longer pay a fee to register your agreement.
...
There is no legally prescribed maximum deposit under Cyprus law. In practice, deposits of **one to two months' rent** are standard. Some landlords ask for two months for unfurnished properties or higher-value rentals.
...
2. Small claims court for amounts under €5,000
3. District court for larger amounts

Court proceedings for tenant-landlord disputes can be slow. Prevention through documentation is significantly more effective than pursuing a dispute after the fact.

---

## Tenant Rights in Cyprus

Cyprus has tenant protection legislation, though enforcement can be slow. Key points:
...
**Termination by the tenant:** Check your agreement for the notice period required if you wish to leave. Most agreements require 1–2 months' written notice. Leaving without proper notice may result in loss of deposit.

---

## Utilities

Setting up utilities in Cyprus is straightforward once you have your rental agreement and Yellow Slip (or are in the process of obtaining it).
...
**Your contract is for less than 12 months.**
You will not be able to use it for the Yellow Slip. Negotiate a minimum 12-month agreement before signing, or ask for a longer initial term.

**The landlord asks for cash rent with no receipts.**
Some landlords in Cyprus prefer informal arrangements. This creates problems: no paper trail for proof of address, no protection if a dispute arises, and potentially illegal income on the landlord's side. Always get receipts or bank transfer records for rent payments.
...
### Can I rent as a non-EU national?
Yes. There are no nationality restrictions on renting property in Cyprus. EU nationals, UK nationals, and non-EU nationals can all rent freely.

### Is stamp duty still due on rental agreements in Cyprus?
No. Stamp duty on rental agreements was abolished as of 1 January 2026.

### What is the minimum rental term for the Yellow Slip?
12 months. Short-term and holiday rental agreements are not accepted by the CRMD for MEU1 applications.
...
**Sources:** PROC-PROP-001 (Renting a Property in Cyprus, draft, April 2026)
