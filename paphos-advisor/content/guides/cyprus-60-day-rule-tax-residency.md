---
title: "Cyprus 60-Day Rule: How to Establish Tax Residency"
slug: /tax-finance/cyprus-60-day-rule-tax-residency/
content_type: guide
target_keyword: cyprus 60 day rule tax residency
secondary_keywords:
  - 60 day rule cyprus
  - how to become tax resident in cyprus
  - cyprus tax residency requirements
  - cyprus 60 days remote worker
  - cyprus dual tax residency 2026
pillar: tax
icp:
...
<!-- Meta title: Cyprus 60-Day Rule: How to Establish Tax Residency | Paphos Advisor -->
<!-- Meta description: The complete guide to Cyprus's 60-day tax residency rule: four conditions, the 2026 dual residency change, step-by-step process, and common mistakes to avoid. -->
...
Cyprus tax law provides two routes to tax residency. The first is the standard 183-day rule: anyone spending more than 183 days in Cyprus in a calendar year automatically becomes a tax resident. The second is the 60-day rule, introduced for internationally mobile individuals who cannot or will not spend most of the year in one country.

Under the 60-day rule, you become a Cyprus tax resident by spending a minimum of 60 days in Cyprus during the calendar year, provided three other conditions are also met. The days do not need to be consecutive.

---

## The four conditions you must meet

All four conditions must be satisfied within the same calendar year.
...
## The 2026 change: dual tax residency is now allowed
...
**What this does not mean:** Holding Cyprus tax residency does not automatically remove your home-country tax obligations. Where two countries both claim tax residency, the relevant double tax treaty determines which country has primary taxing rights. If you have ongoing ties to a high-tax EU jurisdiction, you must take cross-border tax advice before relying on Cyprus non-dom status.

*Source: PwC Direct Tax Update N1/2026; Harneys, January 2026.*
...
- Working remotely for a non-Cyprus employer while physically in Cyprus
- Freelancing or consulting for non-Cyprus clients
- Receiving passive investment income from Cyprus sources
- Owning a Cyprus company without holding a directorship

The practical implication: if you work remotely for a German or Dutch employer and do not have a Cyprus company, you cannot satisfy the economic activity condition without changing your setup. [INTERNAL LINK: /business/cyprus-company-formation/ → anchor text: "Cyprus Company Formation"]

---

## How to establish Cyprus tax residency: step by step

### Step 1: Satisfy the conditions during the calendar year

Ensure that before 31 December you have spent at least 60 days in Cyprus, not spent more than 183 days in any other single country, had a home genuinely available to you in Cyprus all year, and held a Cyprus employment, directorship, or business activity through 31 December.

### Step 2: Keep records of your days in Cyprus throughout the year

The Tax Department can request evidence of physical presence. Keep a travel diary or spreadsheet updated throughout the year, supported by boarding passes, hotel receipts, and bank transaction records.

### Step 3: Register for a Tax Identification Code (TIC)

Apply at your local Tax Department office or via the Taxisnet portal (taxisnet.gov.cy). Bring your passport and proof of Cyprus address. Registration is typically processed the same day. There is no fee.

### Step 4: Create a Taxisnet account

Register on the Cyprus Tax Department's online portal at taxisnet.gov.cy. Your accountant can do this on your behalf with a power of attorney.
...
If you need to demonstrate Cyprus tax residency to a foreign tax authority or bank, request a certificate after your return has been filed. Typically issued within two to four weeks.
...
|---|---|---|
| Passport or ID with travel records | Proof of days in Cyprus | Supported by flight records, boarding passes, hotel receipts |
| Rental agreement or title deed | Proof of permanent home in Cyprus | Must cover the full calendar year; stamped at the Tax Department |
| Employment contract, directorship letter, or company registration | Proof of Cyprus business or employment activity | Must show activity through 31 December |
| Completed TD.1 form | Annual tax return | Filed the year after |
| TIC application | Registration with Tax Department | Applied for at local Tax Department office or online |
...
**Book a free consultation with a Cyprus tax specialist** → [LINK: confirm booking page URL with dev team]
...
<!-- EDITORIAL FLAGS (resolve before publishing)
- Internal links needed: /tax-finance/non-dom-status-cyprus/, /business/cyprus-company-formation/, /immigration/yellow-slip-cyprus/
- Booking CTA URL to confirm with dev team
- Dual residency section: requires tax partner review before publishing (FN-005 in PROC-TAX-PROC-001)
-->
