...
**This file is the catalogue view** — it answers "what content does each segment need and at what priority?" For the pain-point-driven view (which specific anxiety each piece addresses, used as brief-writing input), see `icp-pain-point-content-matrix.md`.

**Sync rule:** When a content title changes in either file, it must be updated in both. These two files are the canonical references for content titles across the system.

**url-slug column:** matches a slug in the [Canonical URL Inventory](../sitemap/canonical-url-inventory.md). A value of `pending` means the piece has no current inventory slot — review whether to add it or merge it into an existing page.
...
|---|---|---|---|---|---|
| Can British citizens move to Cyprus after Brexit? | FAQ / Guide | high | /retirees/category-f-residency | P0 | Most common first question; covered in Category F guide |
...
| Content | Type | Priority | url-slug | phase | Notes |
|---|---|---|---|---|---|
| Yellow Slip (MEU1) — complete guide | Process explainer | high | /tax-residency/yellow-slip | P0 | Most searched process |
| 60-Day Rule Cyprus — full guide | Process explainer | high | /tax-residency/60-day-rule | P0 | Key tax motivation |
| Non-Dom status Cyprus | Process explainer | high | /tax-residency/non-dom | P0 | Key tax motivation |
| Yellow Slip documents checklist | Checklist | high | /tax-residency/yellow-slip-documents | P1 | High practical value |
...
| Content | Type | Priority | url-slug | phase | Notes |
|---|---|---|---|---|---|
| Work with us / Partner with Paphos Advisors (page) | Page | high | /services | P0 | Primary content deliverable for this segment — not an article |
| Regulatory update posts (Category F, MEU1, DNV, 60-day rule changes) | Update | medium | /resources | P0 | Builds authority with professionals; share via email/LinkedIn |
| Deep-dive process guides (Yellow Slip, Category 6.2 PR, company formation) | Guide | medium | /resources | P0 | Demonstrates expertise to professionals who refer clients |
| Developer due diligence resources | Guide | medium | /property/buyer-due-diligence | P1 | Useful for agents and lawyers to share with their clients |
...
| Content | Serves | Priority | url-slug | phase |
|---|---|---|---|---|
| Moving to Cyprus — complete guide | All | high | / | P0 |
| Settling in Paphos checklist | ICP-01, 02, 06 | high | /settling-in | P1 |
| GESY registration guide | All | medium | /settling-in/gesy | P0 |
| Opening a bank account Cyprus | All | medium | /settling-in/bank-account | P0 |
| Cyprus property FAQ | ICP-01, 02, 05, 06 | medium | /faq/property | P1 |
